...
public abstract interface IOFX200BPWServices
  extends EJBObject
{
  ...
  public abstract IntraTrnInfo[] getIntraByRecSrvrTId(String[] paramArrayOfString, boolean paramBoolean)
    throws RemoteException;
  ...
  public abstract RecIntraTrnInfo getRecIntraById(String paramString)
    throws RemoteException;
  
  public abstract RecIntraTrnInfo[] getRecIntraById(String[] paramArrayOfString)
    throws RemoteException;
 ...
 * Qualified Name:     com.ffusion.msgbroker.generated.MessageBroker.api.OFX200.BPWServices.IOFX200BPWServices
