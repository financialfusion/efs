...
public class OFX200BPWServicesBean
  implements SessionBean
{
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      arrayOfTypePmtSyncRsV1 = localBPWEngine.getPendingPmtsByCustomerID200(paramString, paramInt);
    }
    catch (Exception localException)
    {
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      arrayOfTypePmtSyncRsV1 = localBPWEngine.getPendingPmtsAndHistoryByCustomerID200(paramString, paramInt1, paramInt2);
    }
    catch (Exception localException)
    {
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      arrayOfTypeIntraSyncRsV1 = localBPWEngine.getPendingIntrasByCustomerID200(paramString, paramInt);
    }
    catch (Exception localException)
    {
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      arrayOfTypeIntraSyncRsV1 = localBPWEngine.getPendingIntrasAndHistoryByCustomerID200(paramString, paramInt1, paramInt2);
    }
    catch (Exception localException)
    {
      FFSDebug.log("*** getPendingIntrasByCustomerID failed:" + localException.toString() + FFSDebug.stackTrace(localException));
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      return localBPWEngine.getIntraById200(paramString);
    }
    catch (Exception localException)
    {
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      return localBPWEngine.getIntraByRecSrvrTId200(paramArrayOfString, paramBoolean);
    }
    catch (Exception localException)
    {
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      return localBPWEngine.getIntraById200(paramArrayOfString);
    }
    catch (Exception localException)
    {
      FFSDebug.log("*** getIntraById (multiple) failed:" + localException.toString());
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      return localBPWEngine.getPmtById200(paramString);
    }
    catch (Exception localException)
    {
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      return localBPWEngine.getPmtById200(paramArrayOfString);
    }
    catch (Exception localException)
    {
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      return localBPWEngine.getRecPmtById200(paramArrayOfString);
    }
    catch (Exception localException)
    {
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      return localBPWEngine.getRecIntraById200(paramString);
    }
    catch (Exception localException)
    {
      FFSDebug.log("*** getRecIntraById failed:" + localException.toString());
      throw new RemoteException("Server error: " + localException.toString());
    }
  }
    ...
    throws RemoteException
  {
    ...
    {
      BPWEngine localBPWEngine = (BPWEngine)FFSRegistry.lookup("BPWENGINE");
      return localBPWEngine.getRecIntraById200(paramArrayOfString);
    }
    catch (Exception localException)
    {
      FFSDebug.log("*** getRecIntraById (multiple) failed:" + localException.toString());
      throw new RemoteException("Server error: " + localException.toString());
    }
  }
 ...
 * Qualified Name:     com.ffusion.msgbroker.generated.MessageBroker.api.OFX200.BPWServices.OFX200BPWServicesBean
