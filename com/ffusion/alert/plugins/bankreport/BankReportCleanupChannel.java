package com.ffusion.alert.plugins.bankreport;
  ...
  implements IAEChannel
{
    ...
    throws Exception
  {
    ...
    AlertUtil.logEntry("Initializing BankReportCleanupChannel plugin start", this.jdField_for, this.a);
    ...
    this.jdField_do.setProperty("report.type", paramProperties.getProperty("report.type"));
    ...
    AlertUtil.logEntry("Initializing BankReporCleanupChannel plugin end", this.jdField_for, this.a);
  }
  
  public int processAlert(IAEAlertInstance paramIAEAlertInstance, Properties paramProperties)
  {
    AlertUtil.logEntry("Processing BankReportCleanUp Alert...", this.jdField_for, this.a);
    String str1 = paramProperties.getProperty("age.days");
    AlertUtil.logEntry("Processing BankReportCleanUp Alert. Entry age=" + str1, this.jdField_for, this.a);
    ...
    String str2 = paramProperties.getProperty("report.type");
    AlertUtil.logEntry("Processing BankReportCleanUp Alert. Entry age=" + str2, this.jdField_for, this.a);
    if ((str2 == null) || (str2.length() == 0))
    {
      AlertUtil.logEntry("No report type specified. Alert processing failed.", this.jdField_for, this.a);
      return -2000;
    }
    ...
    try
    {
      ...
      localICSILEJB.cleanupBankReport(i, str2, localHashMap);
      try
      {
      ...
      int j;
      AlertUtil.logEntry("Processing  BankReportCleanUpAlert end", this.jdField_for, this.a);
    }
  ...
  public void stop()
  {
    AlertUtil.logEntry("Stopping BankReportCleanupChannel plugin start", this.jdField_for, this.a);
    this.jdField_if = null;
    this.a = null;
    AlertUtil.logEntry("Stopping BankReportCleanupChannel plugin end", this.jdField_for, this.a);
  }
  
  protected String getPluginName()
  {
    return "BankReportCleanup";
  }
}


/* Location:           D:\drops\jd\jars\efs.jar
 * Qualified Name:     com.ffusion.alert.plugins.bankreport.BankReportCleanupChannel
