package com.ffusion.alert.plugins.approvals;
  ...
  implements IAEChannel
{
    ...
    throws Exception
  {
    ...
    AlertUtil.logEntry("Initializing ApprovalsCleanupChannel plugin start", this.jdField_for, paramPrintWriter);
    ...
    AlertUtil.logEntry("Initializing ApprovalsCleanupChannel plugin end", this.jdField_for, paramPrintWriter);
  }
  
  public int processAlert(IAEAlertInstance paramIAEAlertInstance, Properties paramProperties)
  {
    AlertUtil.logEntry("Processing ApprovalsCleanUp Alert...", this.jdField_for, this.a);
    String str = paramProperties.getProperty("age.days");
    AlertUtil.logEntry("Processing ApprovalsCleanUp Alert. Entry age=" + str, this.jdField_for, this.a);
    ...
    try
    {
      ...
      localICSILEJB.cleanupApprovals(i, localHashMap);
      try
      {
      ...
      int j;
      AlertUtil.logEntry("Processing  ApprovalsCleanUpAlert end", this.jdField_for, this.a);
    }
  ...
  public void stop()
  {
    AlertUtil.logEntry("Stopping ApprovalsCleanupChannel plugin start", this.jdField_for, this.a);
    this.jdField_if = null;
    this.a = null;
    AlertUtil.logEntry("Stopping ApprovalsCleanupChannel plugin end", this.jdField_for, this.a);
  }
  
  protected String getPluginName()
  {
    return "ApprovalsCleanup";
  }
}


/* Location:           D:\drops\jd\jars\efs.jar
 * Qualified Name:     com.ffusion.alert.plugins.approvals.ApprovalsCleanupChannel
