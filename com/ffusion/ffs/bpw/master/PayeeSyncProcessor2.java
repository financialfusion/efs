...
public class PayeeSyncProcessor2
  implements DBConsts, FFSConst, OFXConsts, BPWResource, ScheduleConstants
{
  private PayeeProcessor2 jdField_else = null;
  private int jdField_char;
  
  public PayeeSyncProcessor2(PayeeProcessor2 paramPayeeProcessor2)
  {
    this.jdField_else = paramPayeeProcessor2;
    PropertyConfig localPropertyConfig = (PropertyConfig)FFSRegistry.lookup("PROPERTYCONFIG");
    this.jdField_char = localPropertyConfig.LogLevel;
  }
    ...
    throws Exception
  {
    ...
    try
    {
      String str2 = paramTypePayeeSyncRqV1.PayeeSyncRq.SyncRqCm.TokenRqUn.__memberName;
  ...
  private TypePayeeSyncRsV1 a()
  {
    ...
    localTypePayeeSyncRsV1.PayeeSyncRs.SyncRsCm = new TypeSyncRsCm();
    localTypePayeeSyncRsV1.PayeeSyncRs.SyncRsCm.Token = "-1";
    return localTypePayeeSyncRsV1;
  }
    ...
    throws Exception
  {
    ...
    localTypePayeeSyncRsV1.PayeeSyncRs = new TypePayeeSyncRsV1Aggregate();
    localTypePayeeSyncRsV1.PayeeSyncRs.SyncRsCm = new TypeSyncRsCm();
    localTypePayeeSyncRsV1.PayeeSyncRs.SyncRsCm.Token = "0";
    ...
    try
    {
      ...
      TypePayeeTrnRsV1[] arrayOfTypePayeeTrnRsV1 = localAuditAgent.getOFX200PayeeList(str, localFFSConnectionHolder);
      ...
      for (int m = 0; m < j; m++)
      {
        ...
        localTypePayeeSyncRsV1.PayeeSyncRs.PayeeTrnRs[m] = this.jdField_else.processPayeeTrnRqV1(localTypePayeeTrnRqV1, paramTypeUserData, paramString).PayeeTrnRs;
      }
      for (m = j; m < j + i; m++) {
 ...
 * Qualified Name:     com.ffusion.ffs.bpw.master.PayeeSyncProcessor2
