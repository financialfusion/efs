...
import com.ffusion.msgbroker.generated.MessageBroker.mdf.OFX200.TypePmtInqRqAggregate;
import com.ffusion.msgbroker.generated.MessageBroker.mdf.OFX200.TypePmtInqRsAggregate;
import com.ffusion.msgbroker.generated.MessageBroker.mdf.OFX200.TypePmtInqTrnRqV1;
import com.ffusion.msgbroker.generated.MessageBroker.mdf.OFX200.TypePmtInqTrnRqV1Aggregate;
import com.ffusion.msgbroker.generated.MessageBroker.mdf.OFX200.TypePmtInqTrnRsV1;
import com.ffusion.msgbroker.generated.MessageBroker.mdf.OFX200.TypePmtInqTrnRsV1Aggregate;
  ...
  implements BPWResource, DBConsts
{
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      int i = jdMethod_byte(localPmtInfo.Status);
    ...
    {
      String str2 = "*** OFX200Handler.processPmtInqTrnRq failed:";
      FFSDebug.log(str2);
  ...
  private static int jdMethod_byte(String paramString)
  {
    int i;
  ...
  private static TypePmtInqTrnRsV1 a(TypePmtInqTrnRqV1 paramTypePmtInqTrnRqV1, int paramInt, String paramString)
  {
    ...
    localTypePmtInqTrnRsV1.PmtInqTrnRs.PmtInqRs = new TypePmtInqRsAggregate();
    ...
    localTypePmtInqTrnRsV1.PmtInqTrnRs.TrnRsCm = RsCmBuilder.buildTrnRsCmV1(paramTypePmtInqTrnRqV1.PmtInqTrnRq.TrnRqCm, null);
    return localTypePmtInqTrnRsV1;
  }
  ...
  private static TypePmtInqTrnRsV1 jdMethod_try(TypeTrnRqCm paramTypeTrnRqCm, int paramInt, String paramString)
  {
    ...
    localTypePmtInqTrnRsV1.PmtInqTrnRs.TrnRsCm = RsCmBuilder.buildTrnRsCmV1(paramTypeTrnRqCm, paramInt, paramString);
    return localTypePmtInqTrnRsV1;
  }
}
 ...
 * Qualified Name:     com.ffusion.ffs.bpw.master.OFX200Handler
