  ...
  extends FillUserAlert
{
    ...
    throws IOException
  {
    ...
    if (c(localHttpSession))
    {
      ...
      localAccountAlert.setAlertType(4);
  ...
  private boolean c(HttpSession paramHttpSession)
  {
 ...
 * Qualified Name:     com.ffusion.tasks.alerts.FillNSFAlert
