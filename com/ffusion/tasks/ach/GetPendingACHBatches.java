...
public class GetPendingACHBatches
  ...
  implements Task
{
  ...
  public GetPendingACHBatches()
  {
    this.sortedBy = "DATE";
    this.collectionName = "PendingACHBatches";
    this.viewAll = true;
  }
  ...
  {
    ACHBatches localACHBatches = ACH.getPagedPendingACHBatches(paramSecureUser, this.companyID, this.achType, paramPagingContext, paramHashMap);
  ...
  public FilteredList getNext(SecureUser paramSecureUser, PagingContext paramPagingContext, HashMap paramHashMap)
    throws CSILException
  {
    ACHBatches localACHBatches = ACH.getNextPendingACHBatches(paramSecureUser, this.companyID, this.achType, paramPagingContext, paramHashMap);
    if ((localACHBatches != null) && (this.datetype != null)) {
      localACHBatches.setDateFormat(this.datetype);
    }
    return localACHBatches;
  ...
  public FilteredList getPrevious(SecureUser paramSecureUser, PagingContext paramPagingContext, HashMap paramHashMap)
    throws CSILException
  {
    ACHBatches localACHBatches = ACH.getPreviousPendingACHBatches(paramSecureUser, this.companyID, this.achType, paramPagingContext, paramHashMap);
    if ((localACHBatches != null) && (this.datetype != null)) {
      localACHBatches.setDateFormat(this.datetype);
    }
    return localACHBatches;
 ...
 * Qualified Name:     com.ffusion.tasks.ach.GetPendingACHBatches
