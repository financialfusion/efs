...
public class GetMaxAccountGroupAccessLimits
  extends BaseTask
  implements AdminTask
{
    ...
    throws IOException
  {
    ...
    Iterator localIterator1 = localBusinessAccountGroups.iterator();
    while (localIterator1.hasNext()) {
      localArrayList.add(EntitlementsUtil.getEntitlementObjectId((BusinessAccountGroup)localIterator1.next()));
    }
    ...
    jdMethod_char(localLimits, localArrayList);
    localIterator1 = localBusinessAccountGroups.iterator();
    ...
    while (localIterator1.hasNext())
    {
      ...
      localEntitlement.setObjectId(EntitlementsUtil.getEntitlementObjectId(localBusinessAccountGroup));
      ...
      while (localIterator2.hasNext())
      {
        ...
        if (jdMethod_char(localLimit, localEntitlement)) {
      ...
      localHashMap1.put(String.valueOf(localBusinessAccountGroup.getId()), localObject1);
      localHashMap2.put(String.valueOf(localBusinessAccountGroup.getId()), localObject2);
      localHashMap3.put(String.valueOf(localBusinessAccountGroup.getId()), localObject3);
      localHashMap4.put(String.valueOf(localBusinessAccountGroup.getId()), localObject4);
    }
  ...
  private void jdMethod_char(Limits paramLimits, ArrayList paramArrayList)
  {
  ...
  private boolean jdMethod_char(Limit paramLimit, Entitlement paramEntitlement)
  {
 ...
 * Qualified Name:     com.ffusion.tasks.admin.GetMaxAccountGroupAccessLimits
