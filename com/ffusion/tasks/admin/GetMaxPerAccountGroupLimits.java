...
public class GetMaxPerAccountGroupLimits
  extends BaseTask
  implements AdminTask
{
  protected String _listName;
  protected String _accountGroupId;
    ...
    throws IOException
  {
    ...
    jdMethod_new(localLimits, localArrayList);
    ...
    while (localIterator2.hasNext())
    {
      ...
      jdMethod_for(str2, this._accountGroupId, localLimits, localEntitlementTypePropertyLists2, localHashMap1, localHashMap2, localHashMap3, localHashMap4);
    }
  ...
  private static void jdMethod_for(String paramString1, String paramString2, Limits paramLimits, EntitlementTypePropertyLists paramEntitlementTypePropertyLists, HashMap paramHashMap1, HashMap paramHashMap2, HashMap paramHashMap3, HashMap paramHashMap4)
  {
    ...
    EntitlementTypePropertyLists localEntitlementTypePropertyLists = jdMethod_new(paramEntitlementTypePropertyLists.getByOperationName(paramString1), paramEntitlementTypePropertyLists);
    for (int i = 0; i < localEntitlementTypePropertyLists.size(); i++)
    {
      ...
      jdMethod_for(str, paramString2, paramLimits, paramEntitlementTypePropertyLists, paramHashMap1, paramHashMap2, paramHashMap3, paramHashMap4);
      localLimit1 = jdMethod_new(localLimit1, (Limit)paramHashMap1.get(str));
      localLimit2 = jdMethod_new(localLimit2, (Limit)paramHashMap2.get(str));
      localLimit3 = jdMethod_new(localLimit3, (Limit)paramHashMap3.get(str));
      localLimit4 = jdMethod_new(localLimit4, (Limit)paramHashMap4.get(str));
    }
  ...
  private static EntitlementTypePropertyLists jdMethod_new(EntitlementTypePropertyList paramEntitlementTypePropertyList, EntitlementTypePropertyLists paramEntitlementTypePropertyLists)
  {
  ...
  private static Limit jdMethod_new(Limit paramLimit1, Limit paramLimit2)
  {
  ...
  private void jdMethod_new(Limits paramLimits, ArrayList paramArrayList)
  {
    ...
    localEntitlement.setObjectId(this._accountGroupId);
  ...
  private static boolean jdMethod_new(Limit paramLimit, Entitlement paramEntitlement)
  {
  ...
  {
    this._accountGroupId = paramString;
  }
  ...
  private static class a
  {
    ...
    public a(Limits paramLimits, String paramString1, String paramString2)
    {
      ...
      {
        Limit localLimit = (Limit)localIterator.next();
        if (GetMaxPerAccountGroupLimits.jdMethod_new(localLimit, localEntitlement)) {
          switch (localLimit.getPeriod())
          {
          case 1: 
            this.jdField_for = GetMaxPerAccountGroupLimits.jdMethod_new(this.jdField_for, localLimit);
            break;
          case 2: 
            this.jdField_if = GetMaxPerAccountGroupLimits.jdMethod_new(this.jdField_if, localLimit);
            break;
          case 3: 
            this.a = GetMaxPerAccountGroupLimits.jdMethod_new(this.a, localLimit);
            break;
          case 4: 
            this.jdField_do = GetMaxPerAccountGroupLimits.jdMethod_new(this.jdField_do, localLimit);
          }
        }
      }
    }
 ...
 * Qualified Name:     com.ffusion.tasks.admin.GetMaxPerAccountGroupLimits
