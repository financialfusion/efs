...
public class GetChargeableServicesPackageFeatures
  extends BaseTask
  implements BusinessTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      localServiceFeatures2 = Business.getChargeableServiceFeaturesByGroupId(localSecureUser, this.gS, localHashMap);
    }
    ...
    if (this.error == 0)
    {
      ServiceFeatures localServiceFeatures3 = jdMethod_for(localServiceFeatures1, localServiceFeatures2, localSecureUser.getLocale());
      localHttpSession.setAttribute("ChargeableFeatures", localServiceFeatures3);
    }
    return str;
  }
  ...
  public void setServicesPackageId(String paramString)
  {
    try
    {
      this.gS = Integer.parseInt(paramString);
    }
  ...
  private ServiceFeatures jdMethod_for(ServiceFeatures paramServiceFeatures1, ServiceFeatures paramServiceFeatures2, Locale paramLocale)
  {
 ...
 * Qualified Name:     com.ffusion.tasks.business.GetChargeableServicesPackageFeatures
