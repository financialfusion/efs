...
public class GetServicesPackageHistory
  extends BaseTask
  implements BusinessTask
{
    ...
    throws IOException
  {
    ...
    if (this.error == 0)
    {
      ...
      localHistory.setId(this.gt);
      localHistory.setIdType(4);
      ...
      {
        str = this.successURL;
        localHttpSession.setAttribute("ServicesPackageHistories", localHistories);
      }
    }
    return str;
  }
 ...
 * Qualified Name:     com.ffusion.tasks.business.GetServicesPackageHistory
