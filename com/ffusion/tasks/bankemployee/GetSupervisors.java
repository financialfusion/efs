  ...
  implements BankEmployeeTask
{
    ...
    throws IOException
  {
    ...
    Entitlement localEntitlement = new Entitlement("Supervisor", null, null);
    try
    {
    ...
    {
      localHttpSession.setAttribute("Supervisors", localBankEmployees);
      str = this.successURL;
    }
    return str;
  }
 ...
 * Qualified Name:     com.ffusion.tasks.bankemployee.GetSupervisors
