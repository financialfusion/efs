...
public class GetAffiliateBankNames
  extends BaseTask
  implements AffiliateBankTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      localAffiliateBanks = AffiliateBankAdmin.getAffiliateBankNames(localSecureUser, localHashMap);
    }
 ...
 * Qualified Name:     com.ffusion.tasks.affiliatebank.GetAffiliateBankNames
