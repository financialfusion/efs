...
public class UpdateApprovalGroup
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      Approvals.updateApprovalGroup(localSecureUser, localApprovalsGroup, localHashMap);
    }
 ...
 * Qualified Name:     com.ffusion.tasks.approvals.UpdateApprovalGroup
