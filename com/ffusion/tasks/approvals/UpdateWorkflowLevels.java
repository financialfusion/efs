...
public class UpdateWorkflowLevels
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      if (localApprovalsLevels != null) {
        i = localApprovalsLevels.size();
      }
      for (int j = 0; j < i; j++)
      {
        ApprovalsLevel localApprovalsLevel = (ApprovalsLevel)localApprovalsLevels.get(j);
      ...
      Approvals.updateWorkflowLevels(localSecureUser, localApprovalsLevels, localHashMap);
    }
 ...
 * Qualified Name:     com.ffusion.tasks.approvals.UpdateWorkflowLevels
