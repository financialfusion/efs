...
public class RemoveWorkflowLevel
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    ApprovalsLevels localApprovalsLevels = new ApprovalsLevels(localApprovalsLevel.getLocale());
    localApprovalsLevels.add(localApprovalsLevel);
    try
    {
 ...
 * Qualified Name:     com.ffusion.tasks.approvals.RemoveWorkflowLevel
