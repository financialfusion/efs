...
public class GetSubmittedItems
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    String[] arrayOfString = (String[])localHttpSession.getAttribute("ApprovalsStages");
    ...
    try
    {
      ...
      ApprovalsStatuses localApprovalsStatuses = Approvals.getSubmittedItems(i, arrayOfString, localHashMap2, localHashMap1);
 ...
 * Qualified Name:     com.ffusion.tasks.approvals.GetSubmittedItems
