...
public class GetThreadsByAssigned
  extends BaseTask
  implements Task
{
  private String rp = "MessageThreads";
    ...
    throws IOException
  {
    ...
    else
    {
      try
      {
        localMessageThreads = Messages.getThreadsByAssigned(localSecureUser, localHashMap);
      }
    ...
    if (this.error == 0)
    {
      ...
      localHttpSession.setAttribute(this.rp, localMessageThreads);
    }
    this.rp = "MessageThreads";
    return str1;
  }
 ...
 * Qualified Name:     com.ffusion.tasks.messages.GetThreadsByAssigned
