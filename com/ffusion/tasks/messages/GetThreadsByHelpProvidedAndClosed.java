...
public class GetThreadsByHelpProvidedAndClosed
  extends BaseTask
  implements Task
{
  private String sr = "MessageThreads";
    ...
    throws IOException
  {
    ...
    else
    {
      try
      {
        localMessageThreads = Messages.getThreadsByHelpProvidedAndClosed(localSecureUser, localHashMap);
      }
    ...
    if (this.error == 0)
    {
      ...
      localHttpSession.setAttribute(this.sr, localMessageThreads);
    }
    this.sr = "MessageThreads";
    return str1;
  }
 ...
 * Qualified Name:     com.ffusion.tasks.messages.GetThreadsByHelpProvidedAndClosed
