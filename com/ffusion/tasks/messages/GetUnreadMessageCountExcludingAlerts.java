...
public class GetUnreadMessageCountExcludingAlerts
  extends BaseTask
  implements Task
{
    ...
    throws IOException
  {
    ...
    try
    {
      i = Messages.getNumberOfUnreadMessagesExcludingAlerts(localSecureUser, localHashMap);
    }
 ...
 * Qualified Name:     com.ffusion.tasks.messages.GetUnreadMessageCountExcludingAlerts
