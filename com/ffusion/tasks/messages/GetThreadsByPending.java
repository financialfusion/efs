...
public class GetThreadsByPending
  extends BaseTask
  implements Task
{
  private String rt = "MessageThreads";
    ...
    throws IOException
  {
    ...
    else
    {
      try
      {
        localMessageThreads = Messages.getThreadsByPending(localSecureUser, localHashMap);
      }
    ...
    if (this.error == 0)
    {
      ...
      localHttpSession.setAttribute(this.rt, localMessageThreads);
    }
    this.rt = "MessageThreads";
    return str1;
  }
 ...
 * Qualified Name:     com.ffusion.tasks.messages.GetThreadsByPending
