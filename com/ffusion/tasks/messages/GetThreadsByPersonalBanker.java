...
public class GetThreadsByPersonalBanker
  extends BaseTask
  implements Task
{
  private String si = "MessageThreads";
    ...
    throws IOException
  {
    ...
    else
    {
      try
      {
        localMessageThreads = Messages.getThreadsByPersonalBanker(localSecureUser, localHashMap);
      }
    ...
    if (this.error == 0)
    {
      ...
      localHttpSession.setAttribute(this.si, localMessageThreads);
    }
    this.si = "MessageThreads";
    return str1;
  }
 ...
 * Qualified Name:     com.ffusion.tasks.messages.GetThreadsByPersonalBanker
