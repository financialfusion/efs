  ...
  implements Task
{
  ...
  private String qE = "TempMessageQueueActiveMembers";
  private String qC = "TempMessageQueueInactiveMembers";
  ...
  protected String addQueue(HttpSession paramHttpSession)
  {
    this.processFlag = false;
    String str = this.successURL;
    HashMap localHashMap = new HashMap();
    SecureUser localSecureUser = (SecureUser)paramHttpSession.getAttribute("SecureUser");
    localHashMap.put("UserLocale", paramHttpSession.getAttribute("UserLocale"));
    setBankId(localSecureUser.getBankID());
    try
    {
      MessageQueue localMessageQueue = MessageAdmin.addMessageQueue(localSecureUser, this, localHashMap);
    ...
    if (this.validate != null)
    {
      ...
      if (paramLanguageDefns.size() > 1)
      {
        for (int i1 = 0; i1 < paramLanguageDefns.size(); i1++)
        {
          ...
          if (localMessageQueues.getByName(this.language, getQueueName(this.language)) != null)
          {
            this.error = 8058;
            return this.taskErrorURL;
          }
      ...
      else
      {
        ...
        if (((MessageQueues)localObject3).getByName((String)localObject2, getQueueName((String)localObject2)) != null)
        {
          this.error = 8058;
          return this.taskErrorURL;
        }
      ...
      {
        localObject1 = (MessageQueueMembers)paramHttpSession.getAttribute(this.qE);
        localObject2 = (MessageQueueMembers)paramHttpSession.getAttribute(this.qC);
 ...
 * Qualified Name:     com.ffusion.tasks.messages.AddMessageQueue
