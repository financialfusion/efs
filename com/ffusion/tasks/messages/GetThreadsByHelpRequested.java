...
public class GetThreadsByHelpRequested
  extends BaseTask
  implements Task
{
  private String sf = "MessageThreads";
    ...
    throws IOException
  {
    ...
    else
    {
      try
      {
        localMessageThreads = Messages.getThreadsByHelpRequested(localSecureUser, localHashMap);
      }
    ...
    if (this.error == 0)
    {
      ...
      localHttpSession.setAttribute(this.sf, localMessageThreads);
    }
    this.sf = "MessageThreads";
    return str1;
  }
 ...
 * Qualified Name:     com.ffusion.tasks.messages.GetThreadsByHelpRequested
