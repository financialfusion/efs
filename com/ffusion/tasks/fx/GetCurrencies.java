...
public class GetCurrencies
  extends BaseTask
{
  private String WD = "FOREIGN_EXCHANGE_ALL_CURRENCIES";
    ...
    throws IOException
  {
    ...
    try
    {
      localHttpSession.removeAttribute(this.WD);
      FXCurrencies localFXCurrencies = FX.getCurrencies(localSecureUser, localHashMap);
      if ((localSecureUser != null) && (localFXCurrencies != null)) {
        localFXCurrencies.setLocale(localSecureUser.getLocale());
      }
      if (localFXCurrencies != null) {
        localHttpSession.setAttribute(this.WD, localFXCurrencies);
      }
    }
 ...
 * Qualified Name:     com.ffusion.tasks.fx.GetCurrencies
