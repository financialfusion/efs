...
public class GetIntermediaryBanksFromPayee
  extends BaseTask
  implements WireTaskDefines
{
    ...
    throws IOException
  {
    ...
    localHttpSession.setAttribute(this.bankCollectionSessionName, localWireTransferBanks);
    return str;
  }
 ...
 * Qualified Name:     com.ffusion.tasks.wiretransfers.GetIntermediaryBanksFromPayee
