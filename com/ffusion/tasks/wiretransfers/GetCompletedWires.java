...
public class GetCompletedWires
  ...
  implements WireTaskDefines
{
  ...
  public GetCompletedWires()
  {
    this.collectionSessionName = "CompletedWireTransfers";
  }
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      if ((localWireTransfers == null) || (this.firstPage == true))
      {
        ...
        localWireTransfers = Wire.getPagedCompletedWires(localSecureUser, localPagingContext, localHashMap);
      }
  ...
  public void setStartDate(String paramString)
  {
    ...
    {
      System.out.println("GetCompletedWires.setStartDate:Exception = " + localThrowable.getMessage() + "," + localThrowable.toString());
    }
  }
 ...
 * Qualified Name:     com.ffusion.tasks.wiretransfers.GetCompletedWires
