...
public class GetApprovalWireHistories
  ...
  implements WireTaskDefines
{
  ...
  public GetApprovalWireHistories()
  {
    this.beanSessionName = "PendingApprovalWireHistories";
  }
    ...
    throws IOException
  {
    ...
    localWireHistories = (WireHistories)localHttpSession.getAttribute(this.beanSessionName);
    ...
    try
    {
      ...
      if ((localWireHistories == null) || (this.firstPage == true))
      {
        ...
        localWireHistories = Wire.getApprovalWireHistories(localSecureUser, localPagingContext, localHashMap);
      }
      ...
      localHttpSession.setAttribute(this.beanSessionName, localWireHistories);
    }
  ...
  public void setStartDate(String paramString)
  {
    ...
    {
      System.out.println("GetApprovalWireHistories.setStartDate:Exception = " + localThrowable.getMessage() + "," + localThrowable.toString());
    }
  }
 ...
 * Qualified Name:     com.ffusion.tasks.wiretransfers.GetApprovalWireHistories
