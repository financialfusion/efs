...
public class GetCompletedWireHistories
  ...
  implements WireTaskDefines
{
  ...
  public GetCompletedWireHistories()
  {
    this.collectionSessionName = "CompletedWireHistories";
  }
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      if ((localWireHistories == null) || (this.firstPage == true))
      {
        ...
        localWireHistories = Wire.getCompletedWireHistories(localSecureUser, localPagingContext, localHashMap);
      }
  ...
  public void setStartDate(String paramString)
  {
    ...
    {
      System.out.println("GetCompletedWireHistories.setStartDate:Exception = " + localThrowable.getMessage() + "," + localThrowable.toString());
    }
  }
 ...
 * Qualified Name:     com.ffusion.tasks.wiretransfers.GetCompletedWireHistories
