...
public class GetPendingWireBatches
  ...
  implements WireTaskDefines
{
  ...
  public GetPendingWireBatches()
  {
    this.collectionSessionName = "PendingWireBatches";
  }
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      if ((localWireBatches == null) || (this.firstPage == true))
      {
        ...
        localWireBatches = Wire.getPagedPendingWireBatches(localSecureUser, localPagingContext, localHashMap);
      }
  ...
  public void setStartDate(String paramString)
  {
    ...
    {
      System.out.println("GetPendingWireBatches.setStartDate:Exception = " + localThrowable.getMessage() + "," + localThrowable.toString());
    }
  }
 ...
 * Qualified Name:     com.ffusion.tasks.wiretransfers.GetPendingWireBatches
