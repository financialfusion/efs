...
public class GetWireTransferById
  extends ExtendedBaseTask
  implements WireTaskDefines
{
  public GetWireTransferById()
  {
    ...
    throws IOException
  {
    ...
    try
    {
      localWireTransfer = Wire.getWireTransferById(localSecureUser, this.id, localHashMap);
    }
 ...
 * Qualified Name:     com.ffusion.tasks.wiretransfers.GetWireTransferById
