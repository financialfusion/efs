...
public class GetReportPayeeData
  extends SetReportPayee
{
  private String EH = "RegisterTransactions";
  private String EI = "RegisterCategories";
  private String EJ = GenerateReportBase.REPORT_NAME;
  
  public GetReportPayeeData()
  {
    ...
    throws IOException
  {
    ...
    Report localReport = (Report)localHttpSession.getAttribute(this.EJ);
    if (localReport == null)
    {
      this.error = 64;
    ...
    RegisterCategories localRegisterCategories = (RegisterCategories)localHttpSession.getAttribute(this.EI);
    RegisterTransactions localRegisterTransactions = (RegisterTransactions)localHttpSession.getAttribute(this.EH);
 ...
 * Qualified Name:     com.ffusion.tasks.register.GetReportPayeeData
