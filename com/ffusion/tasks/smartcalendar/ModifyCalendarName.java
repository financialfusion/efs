...
public class ModifyCalendarName
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      SmartCalendar.modifyCalendarName(localSecureUser, localSCCalendar, new HashMap());
    }
 ...
 * Qualified Name:     com.ffusion.tasks.smartcalendar.ModifyCalendarName
