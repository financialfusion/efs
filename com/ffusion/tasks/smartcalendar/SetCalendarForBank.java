...
public class SetCalendarForBank
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      String str2 = (String)localHttpSession.getAttribute("SCBankName");
      localHashMap.put("BankName", str2);
      SmartCalendar.setCalendarForBank(localSecureUser, localBankIdentifier, localSCCalendar, localHashMap);
    }
 ...
 * Qualified Name:     com.ffusion.tasks.smartcalendar.SetCalendarForBank
