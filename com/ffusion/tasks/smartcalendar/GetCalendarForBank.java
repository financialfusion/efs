...
public class GetCalendarForBank
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      SCCalendar localSCCalendar = SmartCalendar.getCalendarForBank(localSecureUser, localBankIdentifier, new HashMap());
 ...
 * Qualified Name:     com.ffusion.tasks.smartcalendar.GetCalendarForBank
