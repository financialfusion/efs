  ...
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    this.error = jdMethod_for(localSCCalendar);
    if (this.error != 0) {
      return super.getTaskErrorURL();
    }
    try
    {
      localSCCalendar = SmartCalendar.addCalendar(localSecureUser, localSCCalendar, new HashMap());
      if (localSCCalendar != null) {
  ...
  private int jdMethod_for(SCCalendar paramSCCalendar)
  {
 ...
 * Qualified Name:     com.ffusion.tasks.smartcalendar.AddCalendar
