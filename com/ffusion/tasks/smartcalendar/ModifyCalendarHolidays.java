...
public class ModifyCalendarHolidays
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      SmartCalendar.modifyCalendarHolidays(localSecureUser, localSCCalendar, new HashMap());
    }
 ...
 * Qualified Name:     com.ffusion.tasks.smartcalendar.ModifyCalendarHolidays
