...
public class GetDefaultCalendar
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      SCCalendar localSCCalendar = SmartCalendar.getDefaultCalendar(localSecureUser, new HashMap());
 ...
 * Qualified Name:     com.ffusion.tasks.smartcalendar.GetDefaultCalendar
