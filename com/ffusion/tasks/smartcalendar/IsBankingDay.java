  ...
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      localHttpSession.removeAttribute("SCIsBankingDay");
      boolean bool = SmartCalendar.isBankingDay(localSecureUser, localBankIdentifier, localDate, new HashMap());
      localHttpSession.setAttribute("SCIsBankingDay", new Boolean(bool));
    }
 ...
 * Qualified Name:     com.ffusion.tasks.smartcalendar.IsBankingDay
