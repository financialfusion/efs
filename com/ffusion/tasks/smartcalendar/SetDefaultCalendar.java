...
public class SetDefaultCalendar
  extends BaseTask
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      SmartCalendar.setDefaultCalendar(localSecureUser, localSCCalendar, new HashMap());
    }
 ...
 * Qualified Name:     com.ffusion.tasks.smartcalendar.SetDefaultCalendar
