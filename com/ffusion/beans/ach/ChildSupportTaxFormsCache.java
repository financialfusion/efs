...
public class ChildSupportTaxFormsCache
{
  ...
  public ChildSupportTaxFormsCache()
  {
  ...
  protected TaxForm createCompleteTaxForm(TaxForm paramTaxForm)
  {
    ...
    {
      localObject = (TaxField)localArrayList.get(k);
      if (localTaxForm1.addOrMergeField((TaxField)localObject)) {
    ...
    extends XMLHandler
  {
    ...
    public void startElement(String paramString)
    {
      ...
      if (paramString.equalsIgnoreCase("FORM"))
      {
        ...
        ((TaxForm)localObject).setTypeValue(4);
        ((TaxForm)localObject).setState(this.jdField_int.getState());
        ((TaxForm)localObject).setStateName(this.jdField_int.getStateName());
        ArrayList localArrayList = (ArrayList)ChildSupportTaxFormsCache.formsByState.get(((TaxForm)localObject).getState());
        if (localArrayList == null)
        {
          localArrayList = new ArrayList();
          ChildSupportTaxFormsCache.formsByState.put(((TaxForm)localObject).getState(), localArrayList);
        }
      ...
      else if (paramString.equalsIgnoreCase("FIELD"))
      {
        ...
        if (this.jdField_int != null) {
          ...
          ChildSupportTaxFormsCache.commonFields.add(localObject);
        }
      ...
      {
        if (this.jdField_int != null) {
          ChildSupportTaxFormsCache.commonByState.put(this.jdField_int.getState(), this.jdField_int);
        }
    ...
    public void charData(char[] paramArrayOfChar, int paramInt1, int paramInt2)
    {
      ...
      if (this.jdField_int != null)
      {
        ...
        ChildSupportTaxFormsCache.this.setCompDiscData(str1);
      } else if ((str2.equalsIgnoreCase("COMPANYENTRYDISCRIPTION")) || (str2.equalsIgnoreCase("COMPANYENTRYDESCRIPTION"))) {
        ChildSupportTaxFormsCache.this.setCompEntryDisc(str1);
      } else if (str2.equalsIgnoreCase("COMMENT")) {
        ChildSupportTaxFormsCache.this.setComment(str1);
      }
    }
  }
}
 ...
 * Qualified Name:     com.ffusion.beans.ach.ChildSupportTaxFormsCache
