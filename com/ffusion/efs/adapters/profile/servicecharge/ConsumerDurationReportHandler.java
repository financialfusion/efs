...
public class ConsumerDurationReportHandler
  extends DurationReportHandler
{
  public ConsumerDurationReportHandler(Locale paramLocale)
  {
    super(paramLocale);
  }
    ...
    throws RptException
  {
    ...
    setDimension(localReportResult, 9, getLocale());
    paramReportResult.addSubReport(localReportResult);
    ReportColumn localReportColumn = null;
    ArrayList localArrayList = null;
    addBlankColumns(localReportResult, getLocale(), 4, 18);
    addBlankColumn(localReportResult, getLocale(), 5);
    ...
    throws SQLException, Exception
  {
    ...
    localStringBuffer.append("SELECT a.TRAN_TYPE, a.USER_ID_INT, cust.user_name, a.LOG_DATE FROM AUDIT_LOG a, customer cust WHERE ");
    ...
    localStringBuffer.append(" and cust.directory_id = a.USER_ID_INT ");
    formatLogDatesForSql(localStringBuffer);
    if (getReportCriteria().getAffiliateBankId() != 0)
    {
      localStringBuffer.append(" AND cust.affiliate_bank_id=");
      localStringBuffer.append(getReportCriteria().getAffiliateBankId());
    }
    localStringBuffer.append(" ORDER BY cust.user_name, a.LOG_DATE");
    setReportCriteria(getReportCriteria());
 ...
 * Qualified Name:     com.ffusion.efs.adapters.profile.servicecharge.ConsumerDurationReportHandler
