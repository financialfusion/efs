  ...
  implements Task
{
    ...
    throws IOException
  {
    ...
    try
    {
      Entitlements.modifyMember(EntitlementsUtil.getEntitlementGroupMember(localSecureUser), localEntitlementGroupMember);
    }
 ...
 * Qualified Name:     com.ffusion.efs.tasks.entitlements.ModifyMember
