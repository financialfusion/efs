...
public class AddRestrictedEntitlements
  extends BaseTask
  implements Task
{
    ...
    throws IOException
  {
    ...
    try
    {
      com.ffusion.csil.core.Entitlements.addRestrictedEntitlements(EntitlementsUtil.getEntitlementGroupMember(localSecureUser), localEntitlementGroup.getGroupId(), localEntitlements);
    }
 ...
 * Qualified Name:     com.ffusion.efs.tasks.entitlements.AddRestrictedEntitlements
