...
public class RemoveRestrictedEntitlements
  extends BaseTask
  implements Task
{
    ...
    throws IOException
  {
    ...
    try
    {
      com.ffusion.csil.core.Entitlements.removeRestrictedEntitlements(EntitlementsUtil.getEntitlementGroupMember(localSecureUser), localEntitlementGroup.getGroupId(), localEntitlements);
    }
 ...
 * Qualified Name:     com.ffusion.efs.tasks.entitlements.RemoveRestrictedEntitlements
