    ...
    throws JspException
  {
    try
    {
      ...
      if (localArrayList != null)
      {
        ...
        if (i != 0) {
          localHttpSession.removeAttribute("jtf_authorInfo");
        }
      }
    }
    catch (Exception localException)
    {
      System.out.println("Error: <author:disable> " + localException);
    }
    return 6;
  }
}
 ...
 * Qualified Name:     com.ffusion.jtf.taglib.authoring.disable
