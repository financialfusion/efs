  ...
  implements ACHClassCode, ACHAccountTypes
{
    ...
    throws FIException
  {
    ...
    String str1 = getStringAttribute(paramErrorMessages, paramRecord, "Employee Name", nameRequired(paramMappingDefinition.getMatchRecordsBy()), localLocale);
    String str2 = getStringAttribute(paramErrorMessages, paramRecord, "Employee Identification Number", idRequired(paramMappingDefinition.getMatchRecordsBy()), localLocale);
    String str3 = getStringAttribute(paramErrorMessages, paramRecord, "Employee Routing Number", accountRequired(paramMappingDefinition.getMatchRecordsBy()), localLocale);
    String str4 = getStringAttribute(paramErrorMessages, paramRecord, "Employee Account Number", accountRequired(paramMappingDefinition.getMatchRecordsBy()), localLocale);
    Integer localInteger = getIntegerACHAccountType(paramErrorMessages, paramRecord, "Employee Account Type", accountRequired(paramMappingDefinition.getMatchRecordsBy()), localLocale);
 ...
 * Qualified Name:     com.ffusion.fileimporter.fileadapters.custom.CustomPPDCredit
