  ...
  implements ACHClassCode, ACHAccountTypes
{
    ...
    throws FIException
  {
    ...
    paramHashMap.put("AchClassCode", new Integer(5));
    paramHashMap.put("AchClassCodeText", "POP");
  }
    ...
    throws FIException
  {
    ...
    String str5 = getStringAttribute(paramErrorMessages, paramRecord, "Terminal City", false, localLocale);
    String str6 = getStringAttribute(paramErrorMessages, paramRecord, "Terminal State", false, localLocale);
    String str7 = getStringAttribute(paramErrorMessages, paramRecord, "Discretionary Data", false, localLocale);
    ...
    paramACHEntry.setTerminalCity(str5);
    paramACHEntry.setTerminalState(str6);
    paramACHEntry.setDiscretionaryData(str7);
  }
}


/* Location:           D:\drops\jd\jars\efs.jar
 * Qualified Name:     com.ffusion.fileimporter.fileadapters.custom.CustomPOP
