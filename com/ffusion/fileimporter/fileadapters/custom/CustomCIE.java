  ...
  implements ACHClassCode, ACHAccountTypes
{
    ...
    throws FIException
  {
    ...
    paramHashMap.put("AchClassCode", new Integer(2));
    paramHashMap.put("AchClassCodeText", "CIE");
  }
    ...
    throws FIException
  {
    ...
    String str1 = getStringAttribute(paramErrorMessages, paramRecord, "Customer Name", nameRequired(paramMappingDefinition.getMatchRecordsBy()), localLocale);
    String str2 = getStringAttribute(paramErrorMessages, paramRecord, "Customer Identification Number", idRequired(paramMappingDefinition.getMatchRecordsBy()), localLocale);
    String str3 = getStringAttribute(paramErrorMessages, paramRecord, "Payee Routing Number", accountRequired(paramMappingDefinition.getMatchRecordsBy()), localLocale);
    String str4 = getStringAttribute(paramErrorMessages, paramRecord, "Payee Account Number", accountRequired(paramMappingDefinition.getMatchRecordsBy()), localLocale);
 ...
 * Qualified Name:     com.ffusion.fileimporter.fileadapters.custom.CustomCIE
