  ...
  implements ACHClassCode, ACHAccountTypes
{
    ...
    throws FIException
  {
    ...
    paramHashMap.put("AchClassCode", new Integer(10));
    paramHashMap.put("AchClassCodeText", "WEB");
  }
    ...
    throws FIException
  {
    ...
    String str5 = getStringAttribute(paramErrorMessages, paramRecord, "Single or Recurring Payment", false, localLocale);
    ...
    paramACHEntry.setPaymentTypeCode(str5);
 ...
 * Qualified Name:     com.ffusion.fileimporter.fileadapters.custom.CustomWEB
