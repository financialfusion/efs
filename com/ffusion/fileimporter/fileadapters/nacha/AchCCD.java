  ...
  implements XMLStrings
{
    ...
    throws FIException
  {
    ...
    this.entry.setIdentificationNumber(str5);
    this.entry.setDiscretionaryData(str7);
    this.payee.setUserAccountNumber(str5);
    this.payee.setRoutingNumber(str2);
    this.payee.setAccountNumber(str3);
    this.payee.setName(str6);
    this.payee.setNickName(str6);
 ...
 * Qualified Name:     com.ffusion.fileimporter.fileadapters.nacha.AchCCD
